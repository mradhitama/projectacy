<template>
    <NuxtImg src="https://drive.google.com/uc?export=view&id=1IF3IdkE22Jt7ckUA5_T2k4c4NmQtibUi" alt="Background" loading="lazy"
    ...
    <h5
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
            class="size-9 -rotate-45 group-hover:rotate-0 duration-300 transition-all">
